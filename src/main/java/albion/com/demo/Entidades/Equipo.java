...
public class Equipo {
    ...
    public Equipo(String modelo, String denominacion, String produccion, String titulo_es, String titulo_en, String titulo_fr, String titulo_br, String descripcion_es, String descripcion_en, String descripcion_fr, String descripcion_br, int posicion, boolean alta) {
        this.modelo = modelo;
